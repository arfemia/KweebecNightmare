# Build + install the Kweebec Nightmare plugin jar in one shot.
#
...
Write-Host "`n=== Building KweebecNightmare (gradlew build) ===" -ForegroundColor Cyan
...
# 'KweebecNightmare-*.jar' - that also matches the -sources.jar / -javadoc.jar siblings.
