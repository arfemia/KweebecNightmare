...
> v1.1.0. More Emberbloom stocked for the Warden fight, a leaner standalone install (two companion mods required), and Artillery training on MMO Skill Tree servers. The co-op chase ("Relight & Escape") runs end to end. If something feels off in your server, please report it in my discord so it can be fixed.
...
| Version | Notes                                                                                                                                                                                                                                                                                                                                                                          |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1.1.1 (unreleased) | Requires Ziggfreed's CommonLib 1.4.0 or newer, matching what this build actually needs. Chase rewards now pay out for real on finishing a round, and Amateur, Hardcore, and Nightmare also grant a reward on a loss, not only a win. |
| 1.1.0   | More Emberbloom stocked in the dungeon crypts and their chests. Ships as a standalone jar requiring the Ziggfreed's CommonLib and Perfect Utils companions (previously bundled in). On MMO Skill Tree servers, thrown glow-mushrooms train the Artillery skill.                                                                                                                    |
